...
OU_EXCELROW = {'12': 'B', '07': 'C', '10': 'D', '39': 'E', '03': 'F', '40': 'G', '15': 'H',
			   ...
			   '21': 'P', '18': 'Q',
			   '04': 'S', '14': 'T', '06': 'U', '09': 'V', '41': 'W',
			   '16': 'Y', '29': 'Z', '24': 'AA', '26': 'AB', '25': 'AC', '37': 'AD',
			   '30': 'AE', '28': 'AF', '35': 'AG', '38': 'AH', '42': 'AI', '43': 'AJ'
			   }
...
def createexcel():
	...
	try:
		...
		for tl in tlids:
			...
			lcode = tl['code']
			#if lcode[:3] <= '105' or lcode[:3] in ['135', '140', '145']:
			#	continue

			exname  = tl['name'] + ' '

			for irow in range(8, 91):
